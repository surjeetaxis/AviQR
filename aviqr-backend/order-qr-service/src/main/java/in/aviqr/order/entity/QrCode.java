...
public class QrCode {
    ...
    @Column(nullable=false, unique=true) private String qrCode; // unique short code
    @Column(nullable=false) private String targetUrl;           // permanent URL
    ...
    private String groupParam; // table number, category id etc.
