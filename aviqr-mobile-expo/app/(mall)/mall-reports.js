...
// Outlet comparison — same real per-vendor revenue computation as revenue.js
// (vendor-scoped token + report-service), framed as a vendor leaderboard
// rather than a commission ledger.
export default function MallReportsScreen() {
        ...
        ListHeaderComponent={
          <>
            ...
            <View style={ss.kpiGrid}>
              ...
              <View style={ss.kpiCard}><Text style={ss.kpiVal}>{rows.length}</Text><Text style={ss.kpiLabel}>Vendors tracked</Text></View>
            </View>
          </>
        }
