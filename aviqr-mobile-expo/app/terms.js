...
const SECTIONS = [
  ...
  { h: '4. Account Security', p: 'You are responsible for maintaining the confidentiality of your login credentials and for all activity under your account. Notify us immediately at support@aviqr.com of any unauthorized use.' },
  ...
  { h: '11. Grievance Officer', p: 'Grievance Officer Email: grievance@aviqr.com. Response time: within 30 days of receipt.' },
  { h: '12. Contact', p: 'Email: legal@aviqr.com · Website: aviqr.com' },
];
